...
public class GetRequest implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                Get.resource(request).with(requestSpecification -> requestSpecification.accept(typeContent).relaxedHTTPSValidation())
        );
        log.info(MESSAGE_GENERAL);
        SerenityRest.lastResponse().body().prettyPrint();
    }

    public static Interaction params(String baseUrl, String request, String typeContent) {
